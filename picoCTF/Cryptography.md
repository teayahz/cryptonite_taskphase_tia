...
- This simply seemed to be a monoalphabetic substitution by judging the ending characters matching the patter of the flag, so I used dcode to perform decrypt it, which it did with frequency attack. The final text:
